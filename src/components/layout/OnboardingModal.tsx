            ...
            <div className="space-y-6">
              <div>
                ...
                <input 
                  ...
                  className="w-full bg-slate-raised border-2 border-white/5 rounded-lg p-4 outline-none focus:border-brand-emerald transition-all font-bold text-white"
                />
              </div>
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-2 block">Your Institution / School</label>
                <select
              ...
              <div>
                <label className="text-[10px] font-black uppercase tracking-widest text-white/40 mb-4 block">Fields of Interest</label>
                    ...
                    <button
                      ...
                      className={`px-6 py-2 rounded-lg text-[10px] font-black uppercase tracking-widest border-2 transition-all ${
                        setupForm.interests.includes(option)
                          ...
                          : 'border-white/10 text-white/40 hover:border-brand-emerald/50'
                      }`}
                    >
                      {option}
                    </button>
